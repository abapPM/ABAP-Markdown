CLASS zcl_markdown_emoji DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE.
...
********************************************************************************
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      RETURNING
        VALUE(ro_result) TYPE REF TO zcl_markdown_emoji.
  ...
  PRIVATE SECTION.
    ...
    CLASS-DATA go_emoji TYPE REF TO zcl_markdown_emoji.
...
CLASS zcl_markdown_emoji IMPLEMENTATION.
